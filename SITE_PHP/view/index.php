...
<body>
        ...
        <div class="interface">
            <div class="flex">
                ...
                <div id="destino" class="txt-sobre">
                    ...
                    <p>A Casa Abrigo é um espaço seguro e de recomeço para mulheres vítimas de violência doméstica e sexual, em risco de morte, e seus dependentes. Lá, elas recebem atendimento psicológico, jurídico, pedagógico e de assistência social.</p>
                    <p>O ingresso é feito via encaminhamento da Delegacia Especializada de Atendimento à Mulher, Casa da Mulher Brasileira ou por ordem judicial. As mulheres podem estar acompanhadas de filhos (meninos até 12 anos incompletos e meninas sem limitação de idade). Durante a estadia, recebem cuidados de saúde, apoio para reinserção no mercado de trabalho e direcionamento escolar conforme necessário.</p>
                </div><!--txt-sobre-->
            </div><!--flex-->
        </div><!--interface-->
    </section><!--sobre-->
    ...
    <script>
        ...
        function scrollToDestinoLento() {
            var targetPosition = document.getElementById("destino").offsetTop - 300;
        ...
        setTimeout(scrollToDestinoLento, 100);
    </script>
</body>
</html>
